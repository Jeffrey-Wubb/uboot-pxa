...
#define	CONFIG_SYS_INIT_SP_ADDR		0x5c00f800
...
/* NAND SPL */
#define	CONFIG_SPL
#define	CONFIG_SPL_TEXT_BASE		0x5c014000
...
#define	CONFIG_SYS_NAND_U_BOOT_DST	(PHYS_SDRAM_1)
#define	CONFIG_SYS_NAND_U_BOOT_START	(PHYS_SDRAM_1)
#define	CONFIG_SPL_LDSCRIPT	"board/toradex/colibri_pxa320/u-boot-spl.lds"
#else
